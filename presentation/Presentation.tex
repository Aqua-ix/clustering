...
\begin{frame}\frametitle{実験結果:人工データ}
  \begin{block}{eFCMA}
   \begin{figure}[htbp]
    \begin{center}
    %%\includepdf[]{eFCMA-Lambda10.000000-2d-Gaussian-2clusters.result_classificationFunction.pdf}
   \end{center}
   \captionsetup{labelformat=empty,labelsep=none}
   \caption{$\lambda=10.0$}
  \end{figure}
...
\begin{frame}\frametitle{実験結果:人工データ}
 ...
 \begin{minipage}{0.32\hsize}
  \begin{center}
   %\includegraphics[width=32mm]{qfcma2_2.png}
  \end{center}
  \captionsetup{labelformat=empty,labelsep=none}
...
%\hspace{1cm}
 \begin{minipage}{0.32\hsize}
  \begin{center}
   %\includegraphics[width=32mm]{qfcma1_2.png}
  \end{center}
  \captionsetup{labelformat=empty,labelsep=none}
 ...
 \begin{minipage}{0.32\hsize}
  \begin{center}
   %\includegraphics[width=32mm]{qfcma2_100000.png}
  \end{center}
  \captionsetup{labelformat=empty,labelsep=none}
...
\begin{frame}\frametitle{実験結果:人工データ}
  \begin{block}{sFCMA}
   \begin{figure}[htbp]
    \begin{center}
    %%\includepdf[]{sFCMA-Em2.000000-2d-Gaussian-2clusters.result_classificationFunction.pdf}
   \end{center}
    \captionsetup{labelformat=empty,labelsep=none}
   \caption{$m=2.0$}
  \end{figure}
...
\begin{frame}\frametitle{実験結果:実データ}
  \begin{block}{eFCMA}
   \begin{figure}[htbp]
    \begin{center}
    %%\includegraphics[height=60mm]{efcma_0_01_1.pdf}
   \end{center}
   \captionsetup{labelformat=empty,labelsep=none}
...
\begin{frame}\frametitle{実験結果:実データ}
  \begin{block}{qFCMA}
   \begin{figure}[htbp]
    \begin{center}
    %%\includegraphics[height=60mm]{qfcma_1_00_10_0-1.pdf}
   \end{center}
   \captionsetup{labelformat=empty,labelsep=none}
...
\begin{frame}\frametitle{実験結果:実データ}
  \begin{block}{qFCMA}
   \begin{figure}[htbp]
    \begin{center}
    %%\includegraphics[height=60mm]{qfcma_1_00-0_01_1.pdf}
   \end{center}
   \captionsetup{labelformat=empty,labelsep=none}
...
\begin{frame}\frametitle{実験結果:実データ}
  \begin{block}{sFCMA}
   \begin{figure}[htbp]
    \begin{center}
    %%\includegraphics[height=60mm]{sfcma_1_00_10.pdf}
   \end{center}
   \captionsetup{labelformat=empty,labelsep=none}
